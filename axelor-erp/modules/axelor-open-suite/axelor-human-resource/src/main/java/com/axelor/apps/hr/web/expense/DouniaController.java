...
class DouniaController {
    ...
    @Transactional
    public
    void BordereauEmission(ActionRequest request, ActionResponse response)
    ...
    public
    void OrdrePaiement(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void ReleveBancaire(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    @Transactional
    public
    void pageDeGarde(ActionRequest request, ActionResponse response) throws AxelorException {
