...
class EmployeeAdvanceService {
    ...
    @Transactional
    public
    void fillExpenseWithAdvances(Expense expense) {
        Employee employee =
    ...
    public
    BigDecimal withdrawFromAdvance(
    ...
    @Transactional
    public
    void createEmployeeAdvanceUsage(
    ...
    @Transactional
    public
    Augmentation createAugmentation(Augmentation aug) {
    ...
    @Transactional
    public
    Augmentation Add_default_augmentation(long emp_id) {
        Augmentation au =
    ...
    @Transactional
    public
    Employee update_personnel(Employee emp) {
        return employeeRepository.save(emp);
    }

    public
    int getNombreAugmentation(Long employeeId) {
    ...
    public
    Augmentation getEchelleAtDate(String d1, String d2, Employee emp, String Debut_Fin) {
        ...
        if (Debut_Fin.equals("Debut")) {
            au =
                    Beans.get(AugmentationRepository.class)
                            .all()
                            .filter("?1 between self.dateDebut and (case when self.dateFin is null then now() else self.dateFin end) and self.employer=?3 Order By self.dateFin ASC ",
                                    date1,
                                    date2,
                                    emp)
                            .fetchOne();
    ...
    public
    int getNombreNaissance(String d2, Employee emp, String Debut_Fin) {
        return 0;
    }

    public
    int getNombreEnfantAtDate(Employee emp, String date) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    ...
    public
    String getLastDayByDate(String date) throws ParseException {
    ...
    public
    boolean verifierdate(String d2, LocalDate createdOn) throws ParseException {
    ...
    @Transactional
    public
    void updateEtatSomme(Long id_somme, BigDecimal montant) {
    ...
    public
    String getSitualtionAtDate(LocalDate date, LocalDate marriageDate) {
        String res = " - ";
        int x = marriageDate.compareTo(date);
        if (x < 0) res = "Marié(e)";
        else res = "Célibataire";
    ...
    public
    int getNombreEnfantAtDate_21(Employee employee, String date2) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    ...
    public
    int getNombreEnfantAtDate_21(Employee employee, LocalDate date) {
        int res = 0;
        res =
                Beans.get(NaissancesRepository.class)
                        .all()
    ...
    public
    int getNombreEnfantAtDate_27(Employee employee, LocalDate date) {
        int res = 0;
        res =
                Beans.get(NaissancesRepository.class)
                        .all()
    ...
    String imprimer_EtatEngagement(
        ...
        if (nbr == 0) data.add(String.valueOf(mois + " mois et " + jour + " jours"));
    ...
    @Transactional
    public
    String getDataIndemnite(String dateDebut, String dateFin, Long id_emp, String rappel) {
        List<String> data = new ArrayList<>();
        Employee employee = employeeRepository.find(id_emp);
        int nbr_aug = getNombreAugmentation(employee.getId());
    ...
    public
    Map<String, BigDecimal> getData_By_Date(Employee emp) {
        etat = true;
    ...
    public
    ResponsabiliteList getResponsabiliteAtDate(Employee employee, LocalDate finalD1_moin1Day) {
    ...
    @Transactional
    private
    void saveEtatDesRappelSurSalaire(
    ...
    public
    int getNbrAugmentation(Long id_emp) {
    ...
    private
    boolean employer_has_aos(Employee employee) {
        boolean res = false;
    ...
    private
    BigDecimal getcreditAosAtdate(Employee employee, LocalDate date) {
        BigDecimal res = new BigDecimal(0);
    ...
    public
    boolean verifier_date_debut(Long id_emp, String date_debut) {
        Augmentation one =
    ...
    public
    String getDateDebutAugmentationByEmployer(Long id_emp) {
        String date;
        Augmentation one =
                augmentationRepository
                        .all()
    ...
    public
    Augmentation getEmployer_has_Augmentation(Long id_emp) {
        Augmentation h =
                augmentationRepository
                        .all()
    ...
    @Transactional
    public
    void update_rappel(Long id_emp, LocalDate date_fin) {
    ...
    public
    int getNbrEtatRappel(LocalDate d1, LocalDate d2) {
        int x =
    ...
    public
    BigDecimal getTotalByField(LocalDate d1, LocalDate d2, String param) {
    ...
    public
    BigDecimal getTotalByField(LocalDate d1, LocalDate d2, String param, String Field_toShow) {
        BigDecimal x = BigDecimal.ZERO;
        String req =
                "select sum(s."
                        + param
    ...
    public
    BigDecimal getMontayoub(int mois, int annee) {
        List<EtatSalaire> t =
    ...
    public
    BigDecimal getMontayoub1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
    ...
    public
    BigDecimal getrcarRComp(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getrcarRComp1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getrecore(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getrecore1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getamo(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getamo1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getmutuelleMgpapCcd(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getmutuelleMgpapCcd1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getmutuelleOmfamCaad(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getmutuelleOmfamCaad1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getIR(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getIR1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getpretAxaCredit(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getpretAxaCredit1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getcss(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getcss1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal gettotalRetenue(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal gettotalRetenue1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    List<EtatSalaire> getSalairePlafonne(int mois, int annee) {
        List<EtatSalaire> t =
    ...
    @Transactional
    public
    EtatSalaire saveEtatSalaire(EtatSalaire etatSalaire) {
        return etatSalaireRepository.save(etatSalaire);
    }

    public
    BigDecimal getsumNetAPayer(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=true", annee, mois)
    ...
    public
    BigDecimal getsumNetAPayer1(int mois, int annee) {
        List<EtatSalaire> t =
                etatSalaireRepository
                        .all()
                        .filter("self.annee=?1 and self.mois=?2 and self.titulaire=false", annee, mois)
    ...
    public
    BigDecimal getnetor(BigDecimal mt10, BigDecimal mt9) {
        BigDecimal tab1 = mt9;
    ...
    public
    BigDecimal getnetor1(BigDecimal mt10, BigDecimal mt9) {
        BigDecimal tab1 = mt9;
        BigDecimal tab2 = mt10;
        BigDecimal x = tab1;
        BigDecimal z = tab2;
    ...
    public
    Aos employeHasAOSAtDate(Long idemp, LocalDate d1) {
        Aos ls =
                aosRepository
                        .all()
    ...
    public
    boolean employeHasProlongationAtDate(Long idemp, LocalDate d) {
        boolean res = false;
        Employee emp = employeeRepository.find(idemp);
    ...
    public
    String getRibMutuelle(int id_mutuelle, int annee) {
        String req =
    ...
    public
    List<EtatDesRappelSurSalaire> getAllEtatBetweenDate(LocalDate d1, LocalDate d2) {
    ...
    public
    int getNbrEtatSalaire(Integer mois, Integer annee) {
        int x =
                etatSalaireRepository
                        .all()
    ...
    @Transactional
    public
    void Update_etatSow_true(LocalDate d1, LocalDate d2, String champ) {
        String req =
    ...
    public
    String getTitre(ActionRequest request) {
    ...
    public
    String get_ids_omfam(String omfam_mgpap) {
    ...
    @Transactional
    public
    void saveOrderVirement(OrdreVirement ordreVirement) {
        ordreVirementRepository.save(ordreVirement);
    }

    private
    String mois_format(int month) {
        String res = month < 10 ? ("0" + month) : String.valueOf(month);
        return res;
    }

    public
    int[] getNombreDayRestByEmp(Long id_emp, LocalDate datecheck) {
    ...
    public
    List<JoursFeries> getJourFerierInDate(LocalDate d1, LocalDate d2) {
        List<JoursFeries> ls =
    ...
    public
    int calculateNbrDayOff(LocalDate d1, LocalDate d2, JoursFeries j) {
        int res = 0;
    ...
    public
    int getnbrDayWork(LocalDate d1, LocalDate d2) {
        return ServiceUtil.getnombreJourWork(d1, d2);
    }

    public
    List<Conge> getListCongeByIdEmployer(Long id) {
    ...
    @Transactional
    public
    void addHistoriqueResponsabilite(Long id_employee) {
    ...
    public
    boolean checkNeedAddHitorique(Long id_employee) {
        boolean res = false;
    ...
    @Transactional
    public
    void updateResponsabilite(Long id_employee) {
        Employee employee = employeeRepository.find(id_employee);
        List<HistoriqueResponsabilite> ls =
    ...
    public
    boolean isFirstRappel(Long id_employee) {
    ...
    public
    boolean employerHasWordAtDate(Long id_employee, LocalDate date) {
        List<Augmentation> ls =
                augmentationRepository
                        .all()
    ...
    public
    boolean checkDateDebutIsAfterDateStart(String date_debut, Long id_emp) {
        Employee employee = employeeRepository.find(id_emp);
        LocalDate date = LocalDate.parse(date_debut);
        date = date.minusDays(1);
        if (employee.getDaterecrutement().compareTo(date) > 0) return false;
        return true;
    }

    public
    Employee getEmployerById(Long id_emp) {
        return employeeRepository.find(id_emp);
    }

    public
    Augmentation getAugmentationByEmployee(Long id_emp) {
        return augmentationRepository.all().filter("self.employer=?1", id_emp).fetchOne();
    }

    public
    Augmentation getAugmentationByEtat(Long id_emp, String etat) {
        return augmentationRepository
                .all()
    ...
    @Transactional
    public
    Augmentation saveAugmentation(Augmentation augmentationEncours) {
    ...
    @Transactional
    public
    void removeAugmentationByEmployer(Long id) {
    ...
    public
    BigDecimal getTotalGenerale(Integer mois, Integer annee) {
        BigDecimal total1 =
    ...
    public
    BigDecimal getIrSurLogement(Integer mois, Integer annee) {
    ...
    public
    BigDecimal getTotalAmo(Integer mois, Integer annee) {
        BigDecimal d =
                RunSqlRequestForMe.runSqlRequest_Bigdecimal(
    ...
    public
    BigDecimal getTotalMtTIT(int mois, int annee) {
        BigDecimal mt1 =
                RunSqlRequestForMe.runSqlRequest_Bigdecimal(
    ...
    public
    BigDecimal getMontantOrdreVirementAgent(int page, int mois, int annee) {
        Double mt = 0d;
        List<EtatSalaire> ls =
                etatSalaireRepository
                        .all()
    ...
    public
    Augmentation getFirstAugmentation(Long id_employer) {
        return augmentationRepository
                .all()
    ...
    public
    LocalDate addDayWeekensDayOff(LocalDate d1, LocalDate d2) {
    ...
    @Transactional
    public
    void saveGrade(Grade g) {
        gradeRepository.save(g);
    }

    @Transactional
    public
    void deleteCreateemployerAvancement(int i) {
    ...
    public
    BigDecimal calcule_indemnite_middelDate(
    ...
    public
    Object excuteRequette(int mois, int annee, String req) {
        Object etat = null;
    ...
    public
    BigDecimal salairePlusIndem(int mois, int annee) {
    ...
    @Transactional
    public
    void validerRappel(Augmentation augmentation) {
    ...
    public
    boolean verifier_etatEncNouv(String data1) {
        boolean res = false;
