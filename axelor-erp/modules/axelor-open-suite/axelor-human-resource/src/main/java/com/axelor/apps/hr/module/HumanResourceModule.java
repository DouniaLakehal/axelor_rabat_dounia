...
import com.axelor.apps.hr.service.Etatengagement.AppServiceEtatEngagement;
...
import com.axelor.apps.hr.service.EtatsalaireService.EtatSalaireTransationServiceImplement;
...
public class HumanResourceModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(EtatSalaireTransationService.class).to(EtatSalaireTransationServiceImplement.class);
    bind(EtatEngagmentService.class).to(AppServiceEtatEngagement.class);
  }
}
