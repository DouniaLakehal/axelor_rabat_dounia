...
class ExpenseController {
    ...
    public
    void createAnalyticDistributionWithTemplate(ActionRequest request, ActionResponse response)
    ...
    public
    void computeAnalyticDistribution(ActionRequest request, ActionResponse response)
            throws AxelorException {
        ExpenseLine expenseLine = request.getContext().asType(ExpenseLine.class);
    ...
    public
    void editExpense(ActionRequest request, ActionResponse response) {
    ...
    public
    void editExpenseSelected(ActionRequest request, ActionResponse response) {
    ...
    public
    void validateExpense(ActionRequest request, ActionResponse response) {
    ...
    public
    void historicExpense(ActionRequest request, ActionResponse response) {
    ...
    public
    void showSubordinateExpenses(ActionRequest request, ActionResponse response) {
     ...
     */
    public
    void compute(ActionRequest request, ActionResponse response) {
    ...
    public
    void updateMoveDateAndPeriod(ActionRequest request, ActionResponse response) {
        Expense expense = request.getContext().asType(Expense.class);
    ...
    public
    void ventilate(ActionRequest request, ActionResponse response) throws AxelorException {
        try {
            Expense expense = request.getContext().asType(Expense.class);
    ...
    public
    void printExpense(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    String expenseVentilateMenuTag() {
        Long total =
    ...
    public
    void cancel(ActionRequest request, ActionResponse response) throws AxelorException {
        try {
            Expense expense = request.getContext().asType(Expense.class);
            expense = Beans.get(ExpenseRepository.class).find(expense.getId());
    ...
    public
    void addPayment(ActionRequest request, ActionResponse response) {
        Expense expense = request.getContext().asType(Expense.class);
        expense = Beans.get(ExpenseRepository.class).find(expense.getId());
        try {
     ...
     */
    public
    void cancelPayment(ActionRequest request, ActionResponse response) {
        Expense expense = request.getContext().asType(Expense.class);
        expense = Beans.get(ExpenseRepository.class).find(expense.getId());
        try {
    ...
    public
    void send(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void newExpense(ActionResponse response) {
    ...
    public
    void fillKilometricExpenseProduct(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    public
    void validateAndCompute(ActionRequest request, ActionResponse response) {
    ...
    public
    void computeKilometricExpense(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    public
    void updateKAPOfKilometricAllowance(ActionRequest request, ActionResponse response)
            throws AxelorException {
        ExpenseLine expenseLine = request.getContext().asType(ExpenseLine.class);
    ...
    public
    void domainOnSelectOnKAP(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    public
    void computeDistanceAndKilometricExpense(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    public
    void editBeaudereauEmission(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    public
    void editBeaudereauMensuel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
    ...
    public
    void editVignette(ActionRequest request, ActionResponse response) throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
                        "Février",
    ...
    public
    void editOrdreDeVirement(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
    ...
    public
    void RCAR(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RcarInLog(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RcarP(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void MT_Recore(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MT_Amo(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MtAmoC(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MT_SM_CDD(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void OMFAM(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void IR(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String code = "617111";
        String req =
    ...
    public
    void IrInLog(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void IRC(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void Axa(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void OpCss(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MtMgpapC(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MtIndFonction(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MtLogement(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MtIndVoit(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void MtIndRepresentation(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
    ...
    public
    void Cnopsp(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    Object excuteRequette(int mois, int annee, String code, String req) {
        Object etat = null;
    ...
    public
    void OVRCAR(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void OVAxaCredit(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void OVIR(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void OVCSS(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void OVCNOPS(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
        if (type.isEmpty()) {
    ...
    public
    void editEtatRCAR(ActionRequest request, ActionResponse response)
    ...
    public
    void editEtatRCARSal(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatIR(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
    ...
    public
    void editEtatOMFAM(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
    ...
    public
    void editEtatMGPAP(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = request.getContext().get("type_file").toString();
    ...
    public
    void editEtatAMO(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatAXA(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void verifier_liste_salaire(ActionRequest request, ActionResponse response) {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
    ...
    public
    void imprimerOrdrePayementmt(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    public
    void imprimerOrdrePayementmt1(ActionRequest request, ActionResponse response)
            throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
    ...
    // BeaudereauEmission
    public
    void editBeaudereauEmissionpdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void editBeaudereauEmissionword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void editBeaudereauEmissionexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // editetatrcarsal
    public
    void editEtatRCARSalpdf(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatRCARSalword(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatRCARSalexcel(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editBeaudereauMensuelpdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void editBeaudereauMensuelword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void editBeaudereauMensuelexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // editvignet
    public
    void editVignettepdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
    ...
    public
    void editVignetteword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
    ...
    public
    void editVignetteexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
    ...
    // editetatamo
    public
    void editEtatAMOpdf(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatAMOword(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatAMOexcel(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    // editetatmgpap
    public
    void editEtatMGPAPpdf(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void editEtatMGPAPword(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void editEtatMGPAPexcel(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // editetatomfam
    public
    void editEtatOMFAMpdf(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void editEtatOMFAMword(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void editEtatOMFAMexcel(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // editetetir
    public
    void editEtatIRpdf(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void editEtatIRword(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void editEtatIRexcel(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // editetataxa
    public
    void editEtatAXApdf(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatAXAword(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    public
    void editEtatAXAexcel(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
    ...
    // editetatrcar
    public
    void editEtatRCARpdf(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void editEtatRCARword(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void editEtatRCARexcel(ActionRequest request, ActionResponse response)
            throws AxelorException, ParseException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    public
    void imprimerOrdrePayementmtpdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        int annee = (int) request.getContext().get("annee");
        int mois = (int) request.getContext().get("mois");
        String type = "pdf";
    ...
    public
    void imprimerOrdrePayementmtword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        int annee = (int) request.getContext().get("annee");
        int mois = (int) request.getContext().get("mois");
        String type = "doc";
    ...
    public
    void imprimerOrdrePayementmtexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        int annee = (int) request.getContext().get("annee");
        int mois = (int) request.getContext().get("mois");
        String type = "xls";
    ...
    // rcar
    public
    void RCARpdf(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RCARword(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RCARexcel(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    // IR
    public
    void IRpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String code = "617111";
        String req =
    ...
    public
    void IRword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String code = "617111";
        String req =
    ...
    public
    void IRexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String code = "617111";
        String req =
    ...
    // mt_record
    public
    void MT_Recorepdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void MT_Recoreword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void MT_Recoreexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // OMFAM
    public
    void OMFAMpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void OMFAMword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void OMFAMexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // cnops
    public
    void Cnopsppdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void Cnopspword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void Cnopspexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // axa
    public
    void Axapdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void Axaword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void Axaexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // mt_amo
    public
    void MT_Amopdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void MT_Amoword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void MT_Amoexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // mt_sm_cdd
    public
    void MT_SM_CDDpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void MT_SM_CDDword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void MT_SM_CDDexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // rcarp
    public
    void RcarPpdf(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RcarPword(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RcarPexcel(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    // mtamo
    public
    void MtAmoCpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void MtAmoCword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void MtAmoCexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // irc
    public
    void IRCpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void IRCword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void IRCexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    public
    void imprimerOrdrePayementmt1pdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
    ...
    public
    void imprimerOrdrePayementmt1word(ActionRequest request, ActionResponse response)
            throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
    ...
    public
    void imprimerOrdrePayementmt1excel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        String[] tab_month =
                new String[]{
                        "Janvier",
    ...
    // mtmgpapc
    public
    void MtMgpapCpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void MtMgpapCword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void MtMgpapCexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // mtlogement
    public
    void MtLogementpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void MtLogementword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void MtLogementexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // rcarinlog
    public
    void RcarInLogpdf(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RcarInLogword(ActionRequest request, ActionResponse response) throws AxelorException {
    ...
    public
    void RcarInLogexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
    ...
    // irinlogpdf
    public
    void IrInLogpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void IrInLogword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void IrInLogexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // mtindfonction
    public
    void MtIndFonctionpdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void MtIndFonctionword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void MtIndFonctionexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // mtindvoid
    public
    void MtIndVoitpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void MtIndVoitword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void MtIndVoitexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // mtindrepresentation
    public
    void MtIndRepresentationpdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void MtIndRepresentationword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void MtIndRepresentationexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // editordredevirement
    public
    void editOrdreDeVirementpdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void editOrdreDeVirementword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void editOrdreDeVirementexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    // ovrcar
    public
    void OVRCARpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void OVRCARword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void OVRCARexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // ovcnops
    public
    void OVCNOPSpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void OVCNOPSword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void OVCNOPSexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // ovir
    public
    void OVIRpdf(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
        if (type.isEmpty()) {
    ...
    public
    void OVIRword(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
        if (type.isEmpty()) {
    ...
    public
    void OVIRexcel(ActionRequest request, ActionResponse response) throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
        if (type.isEmpty()) {
    ...
    // ovaaxa
    public
    void OVAxaCreditpdf(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "pdf";
    ...
    public
    void OVAxaCreditword(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "doc";
    ...
    public
    void OVAxaCreditexcel(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer mois = (Integer) request.getContext().get("mois");
        Integer annee = (Integer) request.getContext().get("annee");
        String type = "xls";
    ...
    public
    void imprimmer_declaration_ir(ActionRequest request, ActionResponse response)
            throws AxelorException {
        Integer annee = (Integer) request.getContext().get("annee");
        List<Employee> employee = Beans.get(EmployeeRepository.class).all().fetch();
        Map<Employee, BigDecimal> map = new HashMap<>();
        BigDecimal b = BigDecimal.valueOf(0);
        BigDecimal f = BigDecimal.valueOf(0);
        BigDecimal ir = BigDecimal.valueOf(0);
        BigDecimal ir2 = BigDecimal.valueOf(0);
        for(Employee e : employee) {
            b = appservice.calcule_prime(annee, e.getId()).get("brut");
            ir = appservice.calcule_prime(annee, e.getId()).get("ir");
            f = appservice.calculebrutannee(annee, e.getId()).get("brut");
            ir2 = appservice.calculebrutannee(annee, e.getId()).get("ir");
            map.put(e,b.add(f));
            map.put(e,ir.add(ir2));
        }
      String fileLink =
              ReportFactory.createReport(IReport.DeclarationIR, "Declaration de IR")
                      .addParam("Brut", b.add(f))
                      .addParam("IR", ir.add(ir2))
                      .addParam("annee",annee)
                      .generate()
                      .getFileLink();
      response.setView(ActionView.define("Declaration de IR").add("html", fileLink).map());
    }
}
