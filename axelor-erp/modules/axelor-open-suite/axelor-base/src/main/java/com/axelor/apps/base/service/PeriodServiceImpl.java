...
public class PeriodServiceImpl implements PeriodService {
  ...
  public Period getPeriodb(LocalDate date, Company company, int typeSelect) {
  ...
  public Period getselectbypriode(Period p) {
    return periodRepo
        .all()
        .filter("self.year.name = ?1", String.valueOf(p.getFromDate().getYear()))
        .fetchOne();
  }
}
