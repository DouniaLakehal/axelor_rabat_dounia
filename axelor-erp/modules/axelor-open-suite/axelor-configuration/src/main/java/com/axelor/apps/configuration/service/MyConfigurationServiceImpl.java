...
public class MyConfigurationServiceImpl extends AppBaseServiceImpl
  ...
  @Inject ResponsabiliteRepository responsabiliteRepository;
  ...
  @Inject GestionSalaireRepository gestionSalaireRepository;
  @Inject RCARRepository rcarRepository;
  @Inject IRRepository irRepository;
  @Inject AvancementPeriodeRepository avancementPeriodeRepository;
  ...
  @Inject VersionRBRepository versionRBRepository;
  @Inject BordereauRepository bordereauRepository;
  ...
  @Override
  public RubriquesBudgetaire getRubriqueBudgetaireByYearAndCode(String code, Integer annee) {
    return rubriquesBudgetaireRepository
        .all()
        .filter("self.code_budget=:code and self.anneCurrent=:annee")
        .bind("code", code)
        .bind("annee", annee)
        .fetchOne();
  }
